...
public class CalculatorModel {
    ...
    private int actionSelected; //чтобы хранить какое действие выбрал пользователь
    ...
    public void onNumberPressed (int buttonId){
        ...
        if (state == State.resultShow) {
            state = State.firstArgInput; //если мы показываем результат аргумента то переходим
            //к вводу первого аргумента
